...
ArrayList<ContactModel>arrContact=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  ContactModel model =new ContactModel(R.drawable.f2,"Apple","Rs 100 perk/g");
        ...
        arrContact.add(new ContactModel(R.drawable.apple2,"Apple","Rs200perk/g"));
        arrContact.add(new ContactModel(R.drawable.bana,"Banana","Rs200perk/g"));
        arrContact.add(new ContactModel(R.drawable.download,"Graps","Rs200perk/g"));
        arrContact.add(new ContactModel(R.drawable.orange,"Orange","Rs200perk/g"));
        arrContact.add(new ContactModel(R.drawable.carrots,"Carrot","Rs200perk/g"));
